...
foreach ($index in 0..($computers.Count - 1)) {
    ...
    Start-Job -ScriptBlock {
        ...
        Invoke-Command -ComputerName $Computer -ScriptBlock {
            ...
            $diskspdProc = Start-Process -FilePath $diskspd -ArgumentList "-c${Size}G -d$Duration -r -w10 -t1 -b4K -L -o32 -W15 -D -Suw $testFile" -NoNewWindow -PassThru -RedirectStandardOutput $outputFile
